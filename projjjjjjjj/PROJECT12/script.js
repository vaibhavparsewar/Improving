...
function renderTodos() {
  const todoList = document.getElementById("todoList"); //?html appendChild
  todoList.innerHTML = ""; //?emptying all first
...
function addTodo() {
  const input = document.getElementById("todoInput"); //?html element
